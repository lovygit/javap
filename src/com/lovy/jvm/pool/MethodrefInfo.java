...
public class MethodrefInfo {
    public static final int tag= InfoTag.METHODREF.val;
    ...
    public MethodrefInfo(byte[] buf){
        int tag=buf[0]&0xff;
        if(tag!= MethodrefInfo.tag)
            System.err.println("MethodrefInfo Table Tag Exception");
